...
var BIG_SIZE = SIZE * SIZE_MULTIPLIER;
var MAX_SPEED = 60;
var INIT_SPEED = 6;
var SPEED_STAP = 4;
var FOOD_VALUE = 10;
var BIG_FOOD_VALUE = FOOD_VALUE * SIZE_MULTIPLIER;
var BIG_FOOD_RATIO = 5;
var BIG_FOOD_TIME = 3500;
...
var scoreField = null;
var scoreInCanvasField = null;
var speedField = null;
var wallCollisionInfo = null;
var wallCollisionBar = null;
...
var BigFood = function () {
    function BigFood() {
        _classCallCheck(this, BigFood);
    ...
    _createClass(BigFood, [{
        ...
        key: 'contain',
        value: function contain(x, y) {
            return x === this._x * SIZE_MULTIPLIER && y === this._y * SIZE_MULTIPLIER || x === this._x * SIZE_MULTIPLIER + 1 && y === this._y * SIZE_MULTIPLIER + 1 || x === this._x * SIZE_MULTIPLIER && y === this._y * SIZE_MULTIPLIER + 1 || x === this._x * SIZE_MULTIPLIER + 1 && y === this._y * SIZE_MULTIPLIER;
        }
    }, {
        key: 'x',
        get: function get() {
