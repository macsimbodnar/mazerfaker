...
var SheetSprite = BaseSprite.extend({
    init: function init(sheetImg, clipRect, x, y) {
...
var Player = SheetSprite.extend({
    ...
    updateBullets: function updateBullets(dt) {
...
var Bullet = BaseSprite.extend({
    init: function init(x, y, direction, speed) {
...
var Enemy = SheetSprite.extend({
    init: function init(clipRects, x, y) {
...
var ParticleExplosion = Clazz.extend({
    ...
    createExplosion: function createExplosion(x, y, color, number, width, height, spd, grav, lif) {
...
function setupAlienFormation() {
    ...
    for (var i = 0, len = 5 * 11; i < len; i++) {
        ...
        switch (gridY) {
            case 0:
            case 1:
                clipRects = ALIEN_BOTTOM_ROW;break;
            case 2:
            case 3:
                clipRects = ALIEN_MIDDLE_ROW;break;
            case 4:
                clipRects = ALIEN_TOP_ROW;break;
        }
